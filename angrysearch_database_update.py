...
REPLACING THE OLD ONE, IT RESPECTS directories_excluded

USE CRONTAB TO RUN THIS UPDATE PERIODICLY, 2 TIMES A DAY SOUNDS ABOUT RIGHT
CRONTAB EXAMPLE THAT EXECUTES AT MIDNIGHT AND NOON:

00 00,12 * * * /opt/angrysearch/angrysearch_database_update.py
'''
